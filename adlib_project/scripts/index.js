...
window.onload = () => {
    // the first checkbox, once clicked the event handler is executed
...
function displayIWTBAA_form() {
    ...
    if (firstAdlibColumn.classList.contains("d-none")) {
        firstAdlibColumn.classList.remove("d-none");
        firstAdlibColumn.className = "col-12 col-md-6 col-lg-4";

    }
    else {
        firstAdlibColumn.classList.remove("col-12");
        firstAdlibColumn.classList.remove("col-md-6");
        firstAdlibColumn.classList.remove("col-lg-4");
        firstAdlibColumn.classList.add("d-none");
        document.getElementById("display_adlib_message").remove();
    }
}
...
function displayBFWAD_form() {
    ...
    if (secondAdlibColumn.classList.contains("d-none")) {
        secondAdlibColumn.classList.remove("d-none");
        secondAdlibColumn.className = "col-12 col-md-6 col-lg-4";
    }
    else {
        secondAdlibColumn.classList.remove("col-12");
        secondAdlibColumn.classList.remove("col-md-6");
        secondAdlibColumn.classList.remove("col-lg-4");
        secondAdlibColumn.classList.add("d-none");
        document.getElementById("display_adlib_message").remove();
    }
}
...
function display_HTForm() {
    ...
    if (thirdAdlibColumn.classList.contains("d-none")) {
        thirdAdlibColumn.classList.remove("d-none");
        thirdAdlibColumn.className = "col-12 col-md-6 col-lg-4";
    }
    else {
        thirdAdlibColumn.classList.remove("col-12");
        thirdAdlibColumn.classList.remove("col-md-6");
        thirdAdlibColumn.classList.remove("col-lg-4");
        thirdAdlibColumn.classList.add("d-none");
        document.getElementById("display_adlib_message").remove();
    }
}
